    ...
    return(
        <main className="page px-0 bg-[url('/images/offices_bg.svg')] overflow-x-hidden">
            <section className="mt-10 px-8  pt-16 pb-10">
                <h1 className={`${roboto_slab.className} text-3xl text-primary text-center font-bold my-6 lg:text-[2.5rem] `}>Our Offices</h1>
            ...
            <section className="pt-6 px-8 text-primary lg:py-12">
