...
export default function Home() {
  ...
  return (
    <main className="page overflow-hidden px-0 pt-[85vh]">
      ...
      <div 
        className="absolute w-screen h-screen overflow-hidden brightness-[25%] top-16 bg-slate-900 after:absolute after:w-full after:h-full after:left-0 after:top-0 after:block after:opacity-10 after:m-auto after:bg-slate-200"
        >
