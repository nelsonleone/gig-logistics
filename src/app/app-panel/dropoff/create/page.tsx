...
export default function CreateXpressDropOff(){
    return(
        <AppPanelMCContainer className="relative px-[0.7em] mb-12 text-[#374151] md:px-10 md:py-24">
            ...
            <h2 className="font-semibold mb-8 text-center mx-auto w-1/2">Select an option below and follow the prompt from the comfort of your home or at a GIGL center and proceed to Drop-Off shipments</h2>
