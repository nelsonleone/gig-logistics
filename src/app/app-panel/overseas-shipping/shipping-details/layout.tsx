...
export default function Layout({children}: { children:ReactNode }){
    return(
        <main>
            <section className="text-[#374151]">
                <h1 className={`${roboto_slab.className} font-bold mt-14 mb-8 capitalize text-2xl md:text-3xl text-center lg:px-3`}>Shipping your Items from the UK to NIGERIA is seamless with GIG Logistics.</h1>
                <p className="lg:px-3">
