...
import AppPanelLoader from "../../loading"
...
export default async function PersonalShoppingInfo(){
    ...
    return(
        personalShoppingInfoSanityData ?
        <section>
            <div>
                <div>
