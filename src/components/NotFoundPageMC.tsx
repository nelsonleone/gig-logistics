        ...
        <div className="flex justify-center items-center h-screen w-full">
            <MantineProvider>
                <div className="grid grid-cols-1 gap-8 md:gap-3 md:grid-cols-2">
                    <Image src="/images/not-found-page-img.svg" className="lg:place-self-end" alt="" aria-hidden="true" width={400} height={400} />
                    <div className="md:order-1">
                        ...
                        <Link href="/"  className={`${classes.control} bg-base-color2 p-4 text-center inline-block mt-5 mb-16 text-base-color1 focus:border focus:border-black focus:text-black focus:bg-transparent transition duration-300 ease-in-out hover:border hover:border-black hover:base-color2 hover:bg-transparent`}>
