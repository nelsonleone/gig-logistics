...
function OverseasShippingCompaniesBox({ imgSrc, nameText, imgAlt, linkHref }:IProps) {
    return (
        imgSrc ?
        <Link href={linkHref} className="w-full p-3 rounded-md flex overflow-hidden justify-center items-center border border-gray-100 my-4 shadow-sm h-32 lg:h-28">
