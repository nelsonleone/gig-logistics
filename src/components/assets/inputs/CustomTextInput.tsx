...
import { DeliveryItems, ICODWalletFormValues, IProfileDetailsUpdateFormData, OutBoundShippingSenderInfo, OverseasShippingItemInfo, PersonalShoppingItemDetailsFormInfo, SignInFormData, SignUpFormData } from "../../../../types";

interface IProps {
    error?: string | undefined,
    label: string,
    name:  keyof SignUpFormData | keyof SignInFormData | keyof OverseasShippingItemInfo | keyof ICODWalletFormValues | keyof PersonalShoppingItemDetailsFormInfo | keyof IProfileDetailsUpdateFormData | keyof OutBoundShippingSenderInfo | 'sender.fullName' | 'sender.firstName' | 'sender.lastName' | 'sender.email' | 'sender.phoneNumber' |
