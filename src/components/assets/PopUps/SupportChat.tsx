    ...
    return(
        <>
            ...
            <AnimatePresence>
                {
                    showChat &&
                    <motion.div initial={{opacity:0, y: 200}} animate={{ y: 0, opacity: 1 }} exit={{y: 500, transition: { duration: .8, ease: "linear"} }} className={`${minimizeChat ? "invisible pointer-events-none -z-50" : "z-auto visible pointer-events-auto"} bg-base-color1 fixed z-[10000000] overflow-y-auto shadow-xl shadow-slate-200 rounded-lg h-screen w-full md:w-[30em] top-0 right-0 md:top-4 md:right-4 md:rounded-2xl md:h-[50vh]`}>
