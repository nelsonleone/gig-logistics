        ...
        <Modal open={open} id={id} className="flex justify-center items-center">
            <div className="h-[30em] relative outline-none outline-offset-0 focus:outline-none overflow-y-auto text-[#374151] bg-white shadow-lg rounded-md p-4 md:p-10 w-[95%] md:w-[32em]">
                ...
                <p className="text-center">
                    ...
                    For more information on rates, charges, as well as terms and conditions, please visit <Link className="text-cyan-600 font-medium" href="https://giglogistics.com/faqs">https://giglogistics.com/faqs</Link>

                    With GIGL, overseas shipping is one less thing to worry about.
                </p>

                <button onClick={() => setOpen(false)} className="block rounded-sm text-white bg-black font-medium p-4 text-center mx-auto w-full md:w-[20em] mt-8  hover:opacity-90 focus:bg-transparent focus:text-black focus:outline focus:outline-2 focus:outline-black">Proceed</button>
            </div>
        </Modal>
    )
}