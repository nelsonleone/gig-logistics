...
export default async function FeaturedEventBanner(){
    ...
    return(
        <div className="p-1 py-2 w-full gap-1 md:gap-3 absolute z-20 top-[5rem] flex flex-wrap justify-between items-center bg-black text-white md:justify-center md:px-4 lg:top-[6rem] lg:py-2">
            ...
            <Link className="basis-[40%] md:basis-[auto] red-button-dark p-[.5rem] text-center  text-[.8rem]  w-[50%]  m-auto text-sm md:w-[6rem] md:m-0 md:ml-6 lg:px-6 lg:w-auto hover:brightness-[90%] font-medium focus:outline focus:outline-gray-100"  href={featuredEventData?.eventPageLink || ""}>
                Learn More
            </Link>
        </div>
    )
