                    ...
                    appPanelNavData.map(val => {
                        ...
                        return(
                            <Link
                                ...
                                className={`${pathName.match(`/app-panel/${val.link}`) ? "bg-[rgba(10,10,10,1)] text-white" : "bg-transparent hover:bg-gray-300 focus:bg-gray-300"} px-4 py-3 flex gap-3 text-sm font-medium focus:outline-none`}
                                >
