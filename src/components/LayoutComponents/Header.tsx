...
export default function Header({ children }:{ children: ReactNode }){
    ...
    return(
        ...
        <header className={`fixed top-0 w-full transition-all duration-300 ease-in-out ${isScrolled ? '-translate-y-full' : 'translate-y-[unset]'} bg-slate-50 w-full py-4 px-6 h-20 fixed top-0 z-[59] flex justify-between items-center xl:px-10 lg:py-12 drop-shadow-md`}>
            <MenuIcon />
            <Logo />
            <MainNav />
