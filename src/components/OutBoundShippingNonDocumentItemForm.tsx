...
export default function OutBoundShippingNonDocumentItemForm(){
    ...
    return(
        <form className="pb-12 md:w-3/4 lg:w-1/2 md:mx-auto" onSubmit={handleSubmit(handleAddItem)}>
            ...
            <button className="block w-full rounded-md text-base-color1 bg-base-color2 font-medium p-4 text-center mx-auto mt-16 hover:opacity-90 focus:bg-transparent focus:text-base-color2 focus:outline focus:outline-2 focus:outline-black">Proceed</button>
        </form>
    )
}