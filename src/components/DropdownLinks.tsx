        ...
        <AnimatePresence>
            {
                showDropdownMenu &&
                <motion.ul 
                    exit={{ y: -200, transition: { duration: 1, ease: "linear" } }}
                    id="dropdown"
                    className="w-full bg-slate-100 mt-1 lg:absolute lg:top-4 lg:left-0 lg:w-[15em] lg:bg-gray-50 lg:drop-shadow-xl lg:rounded-md lg:group-hover/dropdownContainer:flex lg:justify-center lg:px-4 lg:flex-col lg:hidden"
                    >
                    {
