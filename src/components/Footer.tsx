...
export default function Footer(){
    return(
        <footer className="bg-[#19191b] bg-[url('/images/footer-bg.2af3a12d.svg')] bg-no-repeat px-3 py-7 bg-blend-hard-light lg:flex lg:flex-row lg:justify-center lg:items-baseline lg:gap-28 lg:py-10">
