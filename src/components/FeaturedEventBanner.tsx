...
export default async function FeaturedEventBanner(){
    ...
    return(
        <div className="p-1 py-2 w-full overflow-hidden gap-1 md:gap-3 absolute z-20 top-[5rem] flex flex-wrap justify-between items-center bg-base-color2 text-base-color1 md:justify-center md:px-4 lg:top-[6rem] lg:py-2">
            {
                featuredEventData ?
                <>
                ...
                :
                <CustomSkeleton variant="rectangular" className="w-full h-full block absolute top-0 bottom-0 left-0 right-0 m-auto" />
            }
        </div>
    )
}