export default function Home() {
  ...
  return (
    <main className="overflow-hidden">
      <div 
        className="relative w-screen h-screen overflow-hidden brightness-50 bg-slate-900"
        >
      ...
      <div 
        ...
        <h1 className="w-5/6 leading-tight font-roboto-slab text-3xl">Delivering Excellence Beyond Boundaries</h1>
